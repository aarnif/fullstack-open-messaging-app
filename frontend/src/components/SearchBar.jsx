...
const SearchBar = ({ searchWord, dataTestId }) => {
  return (
    <div
      ...
      className="flex justify-center items-center my-2 p-1 lg:p-2 border-2 border-slate-100 dark:border-slate-500 rounded-lg bg-slate-100 dark:bg-slate-500 hover:border-violet-500 focus-within:border-violet-500 transition"
    >
